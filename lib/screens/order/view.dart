...
class GarageServiceScreen extends StatefulWidget {
  const GarageServiceScreen({Key? key, this.allWashingModel, this.allGarage})
      : super(key: key);
  final AllWashingModel? allWashingModel;
  final AllGarage? allGarage;

  @override
  State<GarageServiceScreen> createState() => _GarageServiceScreenState();
}
...
class _GarageServiceScreenState extends State<GarageServiceScreen> {
  ...
  void getAllDataservice() async {
    var response = await DioHelper.getData(
        url:
            'all_data_service/${widget.allWashingModel?.id ?? widget.allGarage!.id}');
